	...
	private fun setupUI() {
		...
		if (!weatherResponseJsonString.isNullOrEmpty()) {
			...
			for (z in weatherList.weather.indices) {
				...
				binding?.tvTemp?.text = tempUnit
				val humidityPercent = weatherList.main.humidity.toString() + " per cent"
				binding?.tvHumidity?.text = humidityPercent
				val minTemp = weatherList.main.temp_min.toString() + " min"
				binding?.tvMin?.text = minTemp
				val maxTemp = weatherList.main.temp_max.toString() + " max"
